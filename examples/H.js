// Reactivity framework proposal, code simple
// keep Hell license 66.6 (6.666 bytes long code), see more at janturon.github.io
const H = Object.seal({
    ...
    updateElement: function(elem) {
        ...
        H._getAttrBinding(elem).forEach(bind => {
            ...
            let evaluated = Function(`return ${bind.value}`).call(H.getDataModel(elem));
    ...
    _dataChanged: function(dataObj, prop, prev) {
        ...
        if(prev===undefined || dataObj[prop]!==prev) {
